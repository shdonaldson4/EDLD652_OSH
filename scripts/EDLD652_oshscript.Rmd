...
data3_long$cycle_phase <- ifelse(data3_long$Days_to_menstruation <= 13, "Luteal", ifelse(data3_long$Days_to_menstruation >= 14 | data3_long$Days_to_menstruation <= 18, "Ovulatory", "Follicular"))
